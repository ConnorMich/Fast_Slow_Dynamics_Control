...
plt.subplot(3,1,1)
plt.plot(m.time,q1.value,'k-',label=r'$\theta1$')
# plt.plot(m.time,q2.value,'b-',label=r'$\theta2$')
plt.ylabel('Angle')
plt.legend(loc='best')

plt.subplot(3,1,2)
plt.plot(m.time,q1dot.value,'k-',label=r'$\.\theta1$')
# plt.plot(m.time,q2dot.value,'b-',label=r'$\.\theta2$')
plt.ylabel('Joint Velocity')
plt.legend(loc='best')

plt.subplot(3,1,3)
plt.plot(m.time,tau.value,'r--',label=r'$\tau$')
plt.legend(loc='best')
plt.xlabel('Time')
