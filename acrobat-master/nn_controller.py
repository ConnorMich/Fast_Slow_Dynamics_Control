...
def train_cartpole(trained_dynamic, reward_func, model_name):
    ...
    while i < 150:
        ...
        while True:
            ...
            reward = dqn_solver.reward(state[0], reward_func)
...
def test_cartpole(model_name, num_tests):
    ...
    # score_logger = ScoreLogger(ENV_NAME)
    test_score_manager = Test_Score(dqn_solver.pole_ang_d,dqn_solver.cart_vel_d, model_name) # the desired fast slow dynamics are 0,5
    # vid_manager = video(fs_score_logger.FS_PNG_SINGLE)
